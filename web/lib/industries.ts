// 東証33業種 マスター
// supabase/migrations/002_industries_seed.sql と一致させること
export const INDUSTRIES: { code: number; name: string }[] = [
  { code: 50, name: "水産・農林業" },
  { code: 1050, name: "鉱業" },
  { code: 2050, name: "建設業" },
  { code: 3050, name: "食料品" },
...
export function industryName(code: number | null | undefined): string | null {
